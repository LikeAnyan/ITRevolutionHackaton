...
public class Account {
    ...
    private long birthday; // sets by user, need to determinate y.o., has influence on reducationCoefficient
    private boolean male; // sets by user, has influence on reducationCoefficient
    private double weight; // sets by user, has influence on reducationCoefficient
